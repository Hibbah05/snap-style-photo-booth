  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 bg-background">
      ...
      <div className="grid sm:grid-cols-2 gap-6 w-full max-w-2xl">
        <Link
          to="/capture"
          className="group relative bg-card border border-border p-10 text-center hover:border-foreground hover:-translate-y-1 hover:shadow-lg transition-all animate-scale-in"
        >
          ...
          <p className="text-sm text-muted-foreground font-serif italic">snap three frames live</p>
        </Link>
        <Link
          to="/upload"
          className="group relative bg-card border border-border p-10 text-center hover:border-foreground hover:-translate-y-1 hover:shadow-lg transition-all animate-scale-in"
